...
|  DFP | Downstream Facing Port (aka downstream port). See Figure 2-1.  |
...
|  downstream sublink | The collection of lanes between the DFP Tx and the UFP Rx. See Figure 2-1.  |
