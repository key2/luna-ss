...
in the configuration information. An interface descriptor is always returned as part of a configuration descriptor. Interface descriptors cannot be directly accessed with a GetDescriptor() or SetDescriptor() request.
...
An interface descriptor never includes the Default Control Pipe in the number of endpoints. Table 9-25 shows the standard interface descriptor.

Table 9-25. Standard Interface Descriptor
